...
const CATEGORY_RULES: Array<{ category: string; terms: string[] }> = [
  {
    category: '📜 계약서 / 법률',
    terms: ['계약', '계약서', '갑', '을', '조항', '체결', '특약', '당사자', '해지', '손해배상', '의무', '합의'],
  },
  {
    category: '📊 사업계획서 / 제안서',
    terms: ['사업계획', '사업계획서', '제안서', '추진전략', '로드맵', '시장분석', '비즈니스', '타겟', '수익모델', '투자유치', '비전'],
  },
  {
    category: '💰 재무 / 결산 / 예산',
    terms: ['재무제표', '손익계산서', '결산', '매출', '지출', '예산안', '부가세', '세금계산서', '회계', '영업이익', '대차대조표'],
  },
  {
    category: '📑 견적서 / 명세서',
    terms: ['견적서', '견적', '품명', '수량', '단가', '공급가액', '세액', '합계금액', '발주서', '거래명세서'],
  },
  {
    category: '🔬 연구 / 기술보고서',
    terms: ['연구보고서', '기술보고서', '알고리즘', '아키텍처', '실험결과', '분석결과', '데이터셋', '시스템', '검증', '인공지능'],
  },
  {
    category: '👥 인사 / 총무 / 행정',
    terms: ['근로계약서', '인사평가', '급여명세서', '채용공고', '복무규정', '퇴직금', '신청서', '출장보고서', '회의록'],
  },
];
...
export class KeywordEngine {
  ...
  public static analyzeDocumentText(title: string, text: string): KeywordAnalysisResult {
    ...
    // 1. Tokenize words (Korean/English alpha-numeric)
